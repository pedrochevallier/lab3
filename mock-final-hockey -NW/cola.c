...
int recibir_mensaje(int id_cola_mensajes, long rLongDest, mensaje *rMsg)
{
    ...
    mensaje msg;
    int res;
    res = msgrcv(id_cola_mensajes, (struct msgbuf *)&msg, sizeof(msg.int_rte) + sizeof(msg.int_evento) + sizeof(msg.presidente) + sizeof(msg.vice_presidente), rLongDest, IPC_NOWAIT);
